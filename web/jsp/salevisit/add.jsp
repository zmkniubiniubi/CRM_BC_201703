...
<%--<script type="text/javascript" src="${pageContext.request.contextPath }/jquery/jquery.datepick.js"/>--%>
<%--<script type="text/javascript" src="${pageContext.request.contextPath }/jquery/jquery.datepick-zh-CN.js"/>--%>
<%--<script type="text/javascript">--%>
	<%--$(function(){--%>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
									<s:textfield readonly="false" id="visit_time" cssClass="textbox" cssStyle="WIDTH: 180px" name="visit_time" />
								</td>
								<td>拜访地点 ：</td>
								<td>
							...
							<TR>
								...
								<td>下次拜访时间 ：</td>
								<td>
								<s:textfield readonly="false" id="visit_nexttime" cssClass="textbox" cssStyle="WIDTH: 180px" maxLength="50" name="visit_nexttime"/>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
